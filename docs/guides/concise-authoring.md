...
The `v1alpha1` authoring surface currently includes two additional shorthands
...
1. the actor may mutate only the allowed workspace paths;
2. the actor's successful return does not accept the phase;
