...
func TestGeneratedSchemaArtifactsAreCurrent(t *testing.T) {
	...
	for _, version := range []string{v1alpha1APIVersion, v1alpha2APIVersion, v1alpha3APIVersion, v1alpha4APIVersion} {
...
func TestReferenceDocumentsPointToGeneratedSchemas(t *testing.T) {
	for _, path := range []string{
		...
		filepath.Join("..", "..", "docs", "reference", "agentflow-v1alpha4.md"),
	} {
