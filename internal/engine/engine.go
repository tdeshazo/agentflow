...
func traceFields(fields map[string]string) map[string]string {
	allowed := map[string]bool{
		...
		"context_bytes": true, "context_digest": true, "context_omitted_count": true,
		"context_selected_count": true, "context_version": true, "cost_budget_usd": true, "cost_usd": true,
		...
		"handoff_digest": true, "handoff_status": true, "input_tokens": true, "label": true, "max_attempts": true, "model_config": true,
